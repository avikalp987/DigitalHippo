    ...
    return <MaxWidthWrapper className="bg-white">
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                ...
                <div className="lg:max-w-lg lg:self-end">
                    ...
                    <section className="mt-4">
                        <div className="flex otems-center">
                            <p className="font-medium textgray-900">{formatPrice(product.price)}</p>
                ...
                {/** add to cart  */}
                <div className="mt-10 lg:col-strat-1 lg:row-start-2 lg:max-w-lg lg:self-start">
                    <div>
                        <div className="mt-10">
                            <AddToCartButton />
                        </div>
        ...
        title={`Similar ${label}`}
        subtitle={`Browswe similar high-quality ${label} just like '${product.name}'`}
        />
    </MaxWidthWrapper>
}
