...
const Page = () => {
    ...
    const { mutate: craeteCheckoutSession, isLoading } = trpc.payment.createSession.useMutation({
        onSuccess: ({url}) => {
            if(url)
            {
                router.push(url)
                        ...
                        {isMounted && items.length === 0 ? (
                            <div className="flex flex-col items-center h-full justify-center space-y-1">
                                <div aria-hidden="true"className="relative mb-4 h-40 w-40 text-muted-foreground">
                                    <Image src={"/hippo-empty-cart.png"} alt="empty shopping cart" fill loading="eager"/>
                                </div>
                        ...
                        <ul className={cn({
                            ...
                            {isMounted && items.map(({product})=>{
                                ...
                                return (<li key={product.id} className="flex py-6 sm:py-10">
                                    <div className="flex-shrink-0">
                                        <div className="relative h-24 w-24">
                                            ...
                                            ? (
                                                ...
                                                src={image.url} 
                                                alt="product image" 
                                                className="h-full w-ful rounded-md object-cover object-center sm:h-48 sm:w-48"
                                                />
                                            ) 
                                            : null}
                                        </div>
                                    ...
                                    <div className="ml-4 flex flex-1 flex-col justify-between sm:-6">
                    ...
                    <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
                        ...
                        <div className="mt-6 space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <p className="text-sm font-medium text-fray-900">
                        ...
                        <div className="mt-6">
                            ...
                            onClick={
                                () => craeteCheckoutSession({productIds})
                            }
                            className="w-full" 
                            size="lg">
